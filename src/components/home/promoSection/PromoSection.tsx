const PromoSection = () => {
  return (
    <section className=" h-screen w-full  py-4">
      <div className=" w-full h-full  mx-auto max-w-[90%] lg:px-8 md:px-6 px-4 flex justify-between gap-4 flex-col lg:flex-row">
          ...
          <div className=" w-full relative">
            ...
            <div className=" absolute top-5 md:top-16 right-0 md:w-[33%] w-[38%] h-[58%] ">
              <div className="flex flex-col gap-6 h-full">
                ...
                <button className="hidden md:flex w-[75%] px-2 py-3 text-md font-semibold leading-6 text-black ring-1 ring-gray-600 hover:ring-white/20">
                  Shop collection{" "}
            ...
            <div className=" w-full relative">
              ...
              <div className=" absolute top-8 md:top-16 left-3 md:left-5 w-[70%] h-[75%] ">
                <div className="flex flex-col gap-6 h-full">
                  ...
                  <button className="md:flex hidden w-[75%] px-2 py-3 text-md font-semibold leading-6 text-black ring-1 ring-gray-600 hover:ring-white/20">
                    Shop collection{" "}
                    <span aria-hidden="true" className="text-xl pl-1">
                      {" "}
                      →
        ...
        <div className=" w-full lg:h-full h-[50%] relative">
          ...
          <div className=" absolute top-5 md:top-[30%] right-0 md:w-[33%] w-[38%] h-[58%] ">
            <div className="flex flex-col gap-6 h-full">
              <h5 className="text-gray-600 font-bold">Descuentos de 50%</h5>
